...
#define SMMU_GBPA_UPDATE		BIT(31)
#define SMMU_GBPA_ABORT			BIT(20)

/* SMMU_S_IDR1 register fields */
#define SMMU_S_IDR1_SECURE_IMPL		BIT(31)

/* SMMU_S_INIT register fields */
#define SMMU_S_INIT_INV_ALL		BIT(0)

/* SMMU_S_GBPA register fields */
#define SMMU_S_GBPA_UPDATE		BIT(31)
#define SMMU_S_GBPA_ABORT		BIT(20)

/* SMMU_ROOT_IDR0 register fields */
#define SMMU_ROOT_IDR0_ROOT_IMPL	BIT(0)

/* SMMU_ROOT_CR0 register fields */
#define SMMU_ROOT_CR0_GPCEN		BIT(1)
#define SMMU_ROOT_CR0_ACCESSEN		BIT(0)
...
#define	 IDR0_ST_TERM_MODEL	BIT(26) /* Terminate model behavior */
...
#define	 IDR0_VATOS		BIT(20) /* Virtual ATOS page interface */
#define	 IDR0_CD2L		BIT(19) /* 2-level Context descriptor table*/
#define	 IDR0_VMID16	BIT(18) /* 16-bit VMID supported */
#define	 IDR0_VMW		BIT(17) /* VMID wildcard-matching */
#define	 IDR0_PRI		BIT(16) /* Page Request Interface supported*/
#define	 IDR0_ATOS		BIT(15) /* Address Translation Operations */
#define	 IDR0_SEV		BIT(14) /* WFE wake-up events */
#define	 IDR0_MSI		BIT(13) /* Message Signalled Interrupts */
#define	 IDR0_ASID16	BIT(12) /* 16-bit ASID supported */
#define	 IDR0_NS1ATS	BIT(11) /* Split-stage ATS not supported */
#define	 IDR0_ATS		BIT(10) /* PCIe ATS supported by SMMU */
#define	 IDR0_HYP		BIT(9)/* Hypervisor stage 1 contexts */
#define	 IDR0_DORMHINT	BIT(8) /* Dormant hint supported */
...
#define	 IDR0_BTM		BIT(5) /* Broadcast TLB Maintenance */
#define	 IDR0_COHACC		BIT(4) /* Coherent access to translations*/
...
#define	 IDR0_S1P		BIT(1) /* Stage1 translation supported. */
#define	 IDR0_S2P		BIT(0) /* Stage2 translation supported. */
#define	SMMU_IDR1		0x004
#define	 IDR1_TABLES_PRESET	BIT(30) /* Table base addresses fixed. */
#define	 IDR1_QUEUES_PRESET	BIT(29) /* Queue base addresses fixed. */
#define	 IDR1_REL		BIT(28) /* Relative base pointers */
#define	 IDR1_ATTR_TYPES_OVR	BIT(27) /* Incoming attrs can be overridden*/
#define	 IDR1_ATTR_PERMS_OVR	BIT(26) /* Incoming attrs can be overridden*/
...
#define	 IDR3_RIL		BIT(10) /* Range-based Invalidations. */
...
#define	 IDR5_VAX_52		BIT(10)
#define	 IDR5_GRAN64K		BIT(6) /* 64KB translation granule */
#define	 IDR5_GRAN16K		BIT(5) /* 16KB translation granule */
#define	 IDR5_GRAN4K		BIT(4) /* 4KB translation granule */
...
#define	 CR0_ATSCHK		BIT(4) /* ATS behavior: Safe mode */
#define	 CR0_CMDQEN		BIT(3) /* Enable Command queue processing */
#define	 CR0_EVENTQEN	BIT(2) /* Enable Event queue writes */
#define	 CR0_PRIQEN		BIT(1) /* Enable PRI queue writes */
#define	 CR0_SMMUEN		BIT(0) /* Non-secure SMMU enable */
...
#define	 CR2_PTM		BIT(2) /* Private TLB Maintenance. */
#define	 CR2_RECINVSID		BIT(1) /* Record invalid SID. */
#define	 CR2_E2H		BIT(0) /* Enable EL2-E2H translation regime */
#define	SMMU_STATUSR		0x040
#define	SMMU_GBPA		0x044
#define	SMMU_AGBPA		0x048
#define	SMMU_IRQ_CTRL		0x050
#define	 IRQ_CTRL_EVENTQ_IRQEN	BIT(2) /* NS Event queue interrupts enabled.*/
#define	 IRQ_CTRL_PRIQ_IRQEN	BIT(1) /* PRI queue interrupts are enabled.*/
#define	 IRQ_CTRL_GERROR_IRQEN	BIT(0) /* Global errors int are enabled. */
...
#define	 STRTAB_BASE_RA		BIT64(62) /* Read-Allocate. */
...
#define	 CMDQ_BASE_RA		BIT64(62) /* Read-Allocate. */
...
#define	 EVENTQ_BASE_WA		BIT64(62) /* Write-Allocate. */
...
#define	 PRIQ_BASE_WA		BIT64(62)/* Write-Allocate. */
...
#define	 PREFETCH_0_SSID_S	12
#define	 PREFETCH_0_SSV_S	11
#define	 PREFETCH_0_SSEC_S	10
...
#define	STE0_VALID		BIT(0) /* Structure contents are valid. */
...
#define	STE0_S1CDMAX_M		(0x1FULL << STE0_S1CDMAX_S)

#define	STE1_S1DSS_S		0
#define	STE1_S1DSS_M		(0x3ULL << STE1_S1DSS_S)
#define	STE1_S1DSS_TERMINATE	(0x0ULL << STE1_S1DSS_S)
#define	STE1_S1DSS_BYPASS	(0x1ULL << STE1_S1DSS_S)
#define	STE1_S1DSS_SUBSTREAM0	(0x2ULL << STE1_S1DSS_S)
#define	STE1_S1CIR_S		2
#define	STE1_S1CIR_M		(0x3ULL << STE1_S1CIR_S)
#define	STE1_S1CIR_NC		(0x0ULL << STE1_S1CIR_S)
#define	STE1_S1CIR_WBRA		(0x1ULL << STE1_S1CIR_S)
#define	STE1_S1CIR_WT		(0x2ULL << STE1_S1CIR_S)
#define	STE1_S1CIR_WB		(0x3ULL << STE1_S1CIR_S)
...
#define	STE1_S2HWU59		BIT64(8)
#define	STE1_S2HWU60		BIT64(9)
#define	STE1_S2HWU61		BIT64(10)
#define	STE1_S2HWU62		BIT64(11)
#define	STE1_DRE		BIT64(12) /* Destructive Read Enable. */
#define	STE1_CONT_S		13 /* Contiguous Hint */
#define	STE1_CONT_M		(0xf << STE1_CONT_S)
#define	STE1_DCP		BIT64(17) /* Directed Cache Prefetch. */
#define	STE1_PPAR		BIT64(18) /* PRI Page request Auto Responses */
#define	STE1_MEV		BIT64(19) /* Merge Events */
#define	STE1_S1STALLD		BIT64(27) /* Stage 1 Stall Disable */
#define	STE1_EATS_S		28 /* Enable PCIe ATS translation and traffic */
#define	STE1_EATS_M		(0x3ULL << STE1_EATS_S)
#define	STE1_EATS_ABORT		(0x0ULL << STE1_EATS_S)
#define	STE1_EATS_FULLATS	(0x1ULL << STE1_EATS_S) /* Full ATS */
#define	STE1_EATS_S1		(0x2ULL << STE1_EATS_S) /* Split-stage ATS */
#define	STE1_STRW_S		30 /* StreamWorld control */
#define	STE1_STRW_M		(0x3ULL << STE1_STRW_S)
#define	STE1_STRW_NS_EL1	(0x0ULL << STE1_STRW_S)
#define	STE1_STRW_NS_EL2	(0x2ULL << STE1_STRW_S)
#define	STE1_MEMATTR_S		32
#define STE1_MEMATTR	(0x4ULL << STE1_MEMATTR_S)
#define	STE1_MTCFG		(0x1ULL << 36)
#define	STE1_ALLOCCFG_S		37
#define STE1_ALLOCCFG_RA	(0x4ULL << STE1_ALLOCCFG_S)
...
#define STE1_PRIVCFG_UNPRIV	(0x2ULL << STE1_PRIVCFG_S)
#define STE1_PRIVCFG_PRIV	(0x3ULL << STE1_PRIVCFG_S)
#define	STE1_INSTCFG_S		50
#define STE1_INSTCFG_DATA	(0x2ULL << STE1_INSTCFG_S)
#define STE1_INSTCFG_INST	(0x3ULL << STE1_INSTCFG_S)
...
#define	STE2_S2SL0_L2		(0x0ULL << STE2_S2SL0_S)
#define	STE2_S2SL0_L1		(0x1ULL << STE2_S2SL0_S)
#define	STE2_S2SL0_L0		(0x2ULL << STE2_S2SL0_S)
#define	STE2_S2IR0_S		40
#define	STE2_S2IR0_M		(0x3ULL << STE2_S2IR0_S)
#define	STE2_S2IR0_NC		(0x0ULL << STE2_S2IR0_S)
#define	STE2_S2IR0_WBC_RWA	(0x1ULL << STE2_S2IR0_S)
#define	STE2_S2IR0_WTC_RA	(0x2ULL << STE2_S2IR0_S)
#define	STE2_S2IR0_WBC_RA	(0x3ULL << STE2_S2IR0_S)
#define	STE2_S2OR0_S		42
#define	STE2_S2OR0_M		(0x3ULL << STE2_S2OR0_S)
#define	STE2_S2OR0_NC		(0x0ULL << STE2_S2OR0_S)
#define	STE2_S2OR0_WBC_RWA	(0x1ULL << STE2_S2OR0_S)
#define	STE2_S2OR0_WTC_RA	(0x2ULL << STE2_S2OR0_S)
#define	STE2_S2OR0_WBC_RA	(0x3ULL << STE2_S2OR0_S)
#define	STE2_S2SH0_S		44
#define	STE2_S2SH0_M		(0x3ULL << STE2_S2SH0_S)
#define	STE2_S2SH0_NS		(0x0ULL << STE2_S2SH0_S)
#define	STE2_S2SH0_OS		(0x2ULL << STE2_S2SH0_S)
#define	STE2_S2SH0_IS		(0x3ULL << STE2_S2SH0_S)
#define	STE2_S2TG_S		46
#define	STE2_S2TG_M		(0x3ULL << STE2_S2TG_S)
#define	STE2_S2TG_4KB		(0x0ULL << STE2_S2TG_S)
#define	STE2_S2TG_64KB		(0x1ULL << STE2_S2TG_S)
#define	STE2_S2TG_16KB		(0x2ULL << STE2_S2TG_S)
#define	STE2_S2PS_S		48 /* Physical address Size */
#define	STE2_S2PS_M		(0x7 << STE2_S2PS_S)
#define	STE2_S2AA64		BIT64(51) /* Stage 2 tt is AArch64 */
#define	STE2_S2ENDI		BIT64(52) /* Stage 2 tt endianness */
#define	STE2_S2AFFD		BIT64(53) /* Stage 2 Access Flag Fault Disable*/
#define	STE2_S2PTW		BIT64(54) /* Protected Table Walk */
#define	STE2_S2S		BIT64(57)
#define	STE2_S2R		BIT64(58)
...
#define	CD0_EPD0		BIT(14) /* TT0 walk disable */
#define	CD0_ENDI		BIT(15) /* Big Endian */
...
#define	CD0_EPD1		BIT(30) /* TT1 tt walk disable*/
#define	CD0_VALID		BIT(31) /* CD Valid. */
...
#define	CD0_AFFD		BIT(35) /* Access Flag Fault Disable */
#define	CD0_WXN			BIT(36) /* Write eXecute Never */
#define	CD0_UWXN		BIT(37) /* Unprivileged Write eXecut Never*/
#define	CD0_TBI0		BIT(38) /* Top Byte Ignore for TTB0 */
#define	CD0_TBI1		BIT(39) /* Top Byte Ignore for TTB1 */
#define	CD0_PAN			BIT(40) /* Privileged Access Never */
#define	CD0_AA64		BIT(41) /* TTB{0,1} is AArch64-format TT */
#define	CD0_HD			BIT(42)
#define	CD0_HA			BIT(43)
#define	CD0_S			BIT(44)
#define	CD0_R			BIT(45)
#define	CD0_A			BIT(46)
#define	CD0_ASET		BIT(47) /* ASID Set. */
