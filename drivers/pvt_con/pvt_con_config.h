...
#define PVT_ANALOG_MONITORING	(1U)
	...
	/* PVT_CONTROL */
#define PVT_SINGLE_AVERAGE	(0b00U)	/* Normal Mode */
#define PVT_TWO_AVERAGE		(0b01U)
#define PVT_FOUR_AVERAGE	(0b10U)
#define PVT_EIGHT_AVERAGE	(0b11U)

#define PVT_EXCEED_1_PAST	(0b000U)
#define PVT_EXCEED_2_PAST	(0b010U)
#define PVT_EXCEED_4_PAST	(0b100U)
#define PVT_EXCEED_8_PAST	(0b101U)
#define PVT_EXCEED_12_PAST	(0b110U)
#define PVT_EXCEED_16_PAST	(0b111U)
...
#define PVT_VOLTAGE_IS_VALID_PAST_INDEX(_idx)		\
	...
	/* Vr_PROBE_EN_VS */
#define PVT_VOLTAGE_RANGE_045V	(0b0)	/* 0.45V - 0.90V (Default) */
#define PVT_VOLTAGE_RANGE_025V	(0b1)	/* 0.25V - 0.50V */
