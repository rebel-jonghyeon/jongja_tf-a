...
struct __esf {
	...
	/* Maintain register order for fault handling!!! */
	ulong_t zero;		/* hardwired to zero */
#endif
...
#ifdef CONFIG_SOC_SERIES_RISCV_CMRT
	ulong_t s0;		/* Callee-saved register */
	ulong_t s1;		/* Callee-saved register */
#endif
...
#ifdef CONFIG_SOC_SERIES_RISCV_CMRT
	ulong_t s2;		/* Callee-saved register */
	ulong_t s3;		/* Callee-saved register */
	ulong_t s4;		/* Callee-saved register */
	ulong_t s5;		/* Callee-saved register */
	ulong_t s6;		/* Callee-saved register */
	ulong_t s7;		/* Callee-saved register */
	ulong_t s8;		/* Callee-saved register */
	ulong_t s9;		/* Callee-saved register */
	ulong_t s10;		/* Callee-saved register */
	ulong_t s11;		/* Callee-saved register */
#endif
