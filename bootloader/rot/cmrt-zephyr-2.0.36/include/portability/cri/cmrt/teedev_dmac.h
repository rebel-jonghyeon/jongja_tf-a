...
/**
 * @brief Open DMAC based flash device.
 *
 ...
 */
tee_device_t *teedev_dmac_open(uint32_t base, uint8_t blocks, const uint8_t *path, size_t pathlen);

/**
 * @brief Close DMAC based flash device.
 *
 * Close flash device.
 *
