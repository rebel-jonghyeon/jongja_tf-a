...
#include <teedev.h>
/**
 * @brief Open FLASH based flash device.
 *
 ...
 */
tee_device_t *teedev_flash_open(uint32_t base, uint8_t blocks, const uint8_t *path, size_t pathlen);

/**
 * @brief Close FLASH based flash device.
 *
 * Close flash device.
 *
 * @param[in] dev Pointer to device structure.
 */
void teedev_flash_close(tee_device_t *dev);
