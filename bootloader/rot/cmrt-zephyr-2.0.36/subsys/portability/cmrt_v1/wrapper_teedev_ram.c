...
#define TEEDEV_BLOCK_SIZE CONFIG_TEEDEV_RAM_BLOCK_SIZE
#define TEEDEV_PAGE_SIZE CONFIG_TEEDEV_RAM_PAGE_SIZE
#define TEEDEV_CACHE_PAGES CONFIG_TEEDEV_RAM_CACHE_PAGES
