...
if(CONFIG_64BIT)
    ...
    if(CONFIG_EMBEDDED_ISA)
        string(CONCAT riscv_mabi  "i" ${riscv_mabi} "32e")
        string(CONCAT riscv_march ${riscv_march} "32e")
    else()
        string(CONCAT riscv_mabi  "i" ${riscv_mabi} "32")
        if(CONFIG_SOC_SERIES_RISCV_CMRT)
            string(CONCAT riscv_march ${riscv_march} "32im")
        else()
