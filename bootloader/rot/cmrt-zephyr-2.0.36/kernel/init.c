...
FUNC_NORETURN void z_cstart(void)
{
	...
	/* Fix for kernel samples using the default isr.S and no
	 * multithreading. Must set the irq_stack because isr.S uses it.
	 * Fboot does not need this, it has simple thread free isr.S. */
