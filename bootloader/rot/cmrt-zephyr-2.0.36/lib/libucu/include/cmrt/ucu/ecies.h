...
typedef int cmrt_ecies_t;
#else
typedef struct cmrt_ecies_context *cmrt_ecies_t;
#endif

typedef enum cmrt_ecies_mode_e {
	/** EC: NIST P-256,
	   KDF1 HASH: SHA256
	   AES-CBC: AES-CBC-128
	   HMAC: HMAC-SHA256 */
	CMRT_ECIES_P256_KDF1_SHA256_AES128_HMAC_SHA256,
	/** EC: NIST P-384
	   KDF1 HASH: SHA384
	   AES-CBC: AES-CBC-128
	   HMAC: HMAC-SHA384 */
	CMRT_ECIES_P384_KDF1_SHA384_AES128_HMAC_SHA384,
	/** EC: NIST P-521
	   KDF1 HASH: SHA512
	   AES-CBC: AES-CBC-256
	   HMAC: HMAC-SHA512 */
	CMRT_ECIES_P521_KDF1_SHA512_AES256_HMAC_SHA512,
	/** EC: NIST P-256
	   KDF1 HASH: SHA-3-256
	   AES-CBC: AES-128
	   HMAC: SHA-3-256 */
	CMRT_ECIES_P256_KDF1_SHA3_256_AES128_HMAC_SHA3_256,
	/** EC: NIST P-384
	   KDF1 HASH: SHA-3-384
	   AES-CBC: AES-128
	   HMAC: SHA-3-384 */
	CMRT_ECIES_P384_KDF1_SHA3_384_AES128_HMAC_SHA3_384,
	/** EC: NIST P-521
	   KDF1 HASH: SHA-3-512
	   AES-CBC: AES-128
	   HMAC: SHA-3-512 */
	CMRT_ECIES_P521_KDF1_SHA3_512_AES256_HMAC_SHA3_512
} cmrt_ecies_mode_t;

typedef enum cmrt_ecies_operation_e {
	CMRT_ECIES_ENCRYPT,
	CMRT_ECIES_DECRYPT
} cmrt_ecies_operation_t;

/**
 * In systems with multiple hash cores, secondary HC will be used
 */
#define CMRT_ECIES_O_USE_HC2          (0x1 << 16)
 ...
 *
 * @param flags CMRT_ECIES_O_USE_HC2 to use HC2 for hash operations.
 * @return Context handle on success, CMRT_INVALID_HANDLE on error.
 */
 ...
 * @param mode A cmrt_ecies_mode_t enumeration that selects the ECIES
 *             mode of operation and the suite of cryptographic primitives
 *             to be used.
 * @param operation A cmrt_ecies_operation_t enumeration that selects whether the
 ...
 */
int cmrt_ecies_init(cmrt_ecies_t ecies,
 ...
 * @return Zero on success, -ERRNO on error.
 */
int cmrt_ecies_update(cmrt_ecies_t ecies,
		      const void *input,
		      size_t inputlen,
		      void *output);
 ...
 * @return Zero on success, -ERRNO on error.
 */
int cmrt_ecies_final(cmrt_ecies_t ecies,
		     const void *input,
		     size_t inputlen,
