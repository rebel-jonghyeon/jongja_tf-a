 ...
 * [31:16+N] : RSVD	/ [15+N:16] : TRIMINFO_125
...
union pvt_t_triminfo1_reg {
	struct {
		...
		RO uint32_t triminfo_125:PVT_TEMPERATURE_N;
		...
		/* bits[15+N:16] | R  | OTP information for 125	| Reset Value = 0x000 */
 ...
 */
/* TODO: Add macro in threshold temp fall */
