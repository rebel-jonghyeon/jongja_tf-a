...
{
	/*
	 * Set trap vector here, now we have kernel initialized and
	 * handling traps directly in __irq_wrapper makes sense.
	 */
	__asm__ volatile("la t0, __irq_wrapper\n"
			 "csrw " STRINGIFY(SOC_MTVEC_REG) ", t0\n");
}
