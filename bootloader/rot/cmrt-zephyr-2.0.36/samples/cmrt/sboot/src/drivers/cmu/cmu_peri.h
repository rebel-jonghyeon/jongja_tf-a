...
union cmu_peri_peri_cmu_peri__controller_option {
	struct {
...
union cmu_peri_clkout_con_blk_peri_cmu_peri__clkout {
	struct {
...
union cmu_peri_clk_con_gat_clk_blk_peri_uid_peri_cmu_peri__ipclkport_pclk {
	struct {
...
union cmu_peri_qch_con_peri_cmu_peri__qch {
	struct {
		uint32_t enable:1; /* [0:0] */
		uint32_t clock_req:1; /* [1:1] */
		uint32_t ignore_force_pm_en:1; /* [2:2] */
...
struct cmu_peri_cont {
	union cmu_peri_peri_cmu_peri__controller_option
		peri_cmu_peri__controller_option; /* offset : 0x800 */
	union cmu_peri_clkout_con_blk_peri_cmu_peri__clkout
		clkout_con_blk_peri_cmu_peri__clkout; /* offset : 0x804 */
...
struct cmu_peri_gate {
	union cmu_peri_clk_con_gat_clk_blk_peri_uid_peri_cmu_peri__ipclkport_pclk
		clk_con_gat_clk_blk_peri_uid_peri_cmu_peri__ipclkport_pclk; /* offset : 0x2000 */
	union cmu_peri_clk_con_gat_clk_blk_peri_uid_nic_peri_ipclkport_pckclk
...
struct cmu_peri_qch {
	...
	union cmu_peri_qch_con_peri_cmu_peri__qch qch_con_peri_cmu_peri__qch; /* offset : 0x3048 */
