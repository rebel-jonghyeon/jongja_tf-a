...
struct sysreg_sysremap {
	volatile uint32_t m3_user_ovrd_value;
	volatile uint32_t rsvd[27];
	volatile uint32_t m3_user_ovrd_sel;
};
 ...
 */
#define DMA_TIMEOUT_US		100000000
...
#define OP_DMA_KILL			0x1
#define SZ_CMD_DMAMOV		0x6

#define DMA_MAX_SIZE_LIMIT	(0x40000)
