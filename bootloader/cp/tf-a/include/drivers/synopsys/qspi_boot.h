...
struct dwc_ssi_config {
	volatile struct dwc_ssi *reg_base;
	uint32_t spi_mode;
};

#define QSPI_BOOT_CTRLR0_TMOD_TX_RX		(0)
#define QSPI_BOOT_CTRLR0_TMOD_TX		(1)
#define QSPI_BOOT_CTRLR0_TMOD_RX		(2)

#define QSPI_BOOT_CTRLR0_SPI_FRF_STANDARD	(0x0)
#define QSPI_BOOT_CTRLR0_SPI_FRF_QSPI		(0x2)

#define QSPI_BOOT_SPI_CTRLR0_INST_L_8				(0x2)

#define QSPI_BOOT_SPI_CTRLR0_ADDR_L_0				(0x00)
#define QSPI_BOOT_SPI_CTRLR0_ADDR_L_8				(0x02)
#define QSPI_BOOT_SPI_CTRLR0_ADDR_L_24				(0x06)

#define QSPI_BOOT_SPI_CTRLR0_TRANS_TYPE_TT0			(0)
#define QSPI_BOOT_SPI_CTRLR0_TRANS_TYPE_TT2			(2)

#define QSPI_BOOT_TXFTLR_0WORD						(0)

#define QSPI_BOOT_INSTRUCTION_READ_STATUS_0WAIT		(0x40)
#define QSPI_BOOT_INSTRUCTION_READ_STATUS_1WAIT		(0x48)
#define QSPI_BOOT_INSTRUCTION_READ_STATUS_2WAIT		(0x50)

/* todo - other DFS */
#define QSPI_BOOT_CTRLR0_DFS_8			(0x07)
#define QSPI_BOOT_CTRLR0_DFS_16			(0x0F)
#define QSPI_BOOT_CTRLR0_DFS_32			(0x1F)

#define QSPI_BOOT_FIFO_DEPTH			(32)

/* Other values & definitions */
#define QSPI_BOOT_DEFAULT_DELAY_COUNT		10000
#define QSPI_BOOT_WAIT_0				0
#define QSPI_BOOT_WAIT_8				8
#define QSPI_BOOT_WAIT_10				10

#define QSPI_BOOT_SPI_CTRLR0_INST_L_0				(0x0)
#define QSPI_BOOT_SPI_CTRLR0_INST_L_8				(0x2)

#define QSPI_BOOT_CTRLR1_NDF_1WORD					(0)
#define QSPI_BOOT_CTRLR1_NDF_2WORD					(1)
#define QSPI_BOOT_CTRLR1_NDF_16WORD					(15)
