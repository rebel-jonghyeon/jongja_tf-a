...
#include "../terminal_service/terminal_task.h"
#include "rbln/abort.h"

//TODO: Uncomment after porting terminal_task
// Print out to the shell and the log buffer both.
//#define printf(...) LOG_ASSERT(__VA_ARGS__)
...
{
#ifdef __unused_MULTI_EL__  /* in CP FW, all the addresses are readable */
