...
#ifndef _ATOMIC_BUILTIN_H
#define _ATOMIC_BUILTIN_H
...
static inline atomic_val_t atomic_or_relaxed(atomic_t *target, atomic_val_t value)
{
	return __atomic_fetch_or(target, value, __ATOMIC_RELAXED);
}
...
static inline atomic_val_t atomic_and_relaxed(atomic_t *target, atomic_val_t value)
{
	return __atomic_fetch_and(target, value, __ATOMIC_RELAXED);
}
