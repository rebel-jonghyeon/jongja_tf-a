...
#    warning "incbin is incompatible with bitcode. Using the library will break upload \
#             to App Store if you have bitcode enabled. Add \
#             `#define INCBIN_SILENCE_BITCODE_WARNING` before \
#             including this header to silence this warning."
#  endif
...
#define INCBIN_GLOBAL_LABELS(NAME, TYPE) \
		INCBIN_INVOKE(INCBIN_GLOBAL, INCBIN_CONCATENATE(NAME,	\
			INCBIN_INVOKE(INCBIN_STYLE_IDENT, TYPE)))			\
		INCBIN_INVOKE(INCBIN_TYPE, INCBIN_CONCATENATE(NAME,		\
			INCBIN_INVOKE(INCBIN_STYLE_IDENT, TYPE)))
...
#define INCBIN_3(TYPE, NAME, FILENAME) INCBIN_COMMON(TYPE, NAME, FILENAME, \
														/* No terminator for binary data */)
#define INCBIN_COMMON(TYPE, NAME, FILENAME, TERMINATOR) \
	__asm__(INCBIN_SECTION \
			...
			INCBIN_MANGLE INCBIN_STRINGIZE(INCBIN_PREFIX) #NAME INCBIN_STYLE_STRING(SIZE) ":\n" \
				INCBIN_INT INCBIN_MANGLE INCBIN_STRINGIZE(INCBIN_PREFIX) #NAME \
												INCBIN_STYLE_STRING(END) " - " \
						   INCBIN_MANGLE INCBIN_STRINGIZE(INCBIN_PREFIX) #NAME \
												INCBIN_STYLE_STRING(DATA) "\n" \
			INCBIN_ALIGN_HOST \
			".text\n" \
	); \
