...
#ifndef _DNC_REGS_EVT1_H_
#define _DNC_REGS_EVT1_H_
...
/* Prevent g_dnc_task_32b.h from including evt0/g_dnc_task_32b.h */
#define _G_DNC_TASK_32B_EVT0_H_
#include "g_dnc_task_32b.h"
#undef _G_DNC_TASK_32B_EVT0_H_

/* Prevent g_dnc_sync.h from including evt0/g_dnc_sync.h if it does */
#define _G_DNC_SYNC_EVT0_H_
#include "g_dnc_sync.h"
#undef _G_DNC_SYNC_EVT0_H_

/* Undefine conflicting macros and unions before evt1 headers redefine them */
#undef ADDR_OFFSET_DNC_TASK_16B

/* Undefine unions that will be redefined by evt1 headers */
#undef dnc_task_desc_tsync
#undef dnc_task_do
#undef dnc_task_trig
#undef dnc_task_comp_task_fetch1
#undef dnc_task_ldudma_task_fetch1
#undef dnc_task_lpudma_task_fetch1
#undef dnc_task_studma_task_fetch1
#undef dnc_task_delay
#undef dnc_sync_trig

#include "evt1/g_dnc_memory_map.h"
#include "evt1/g_dnc_config.h"
#include "evt1/g_dnc_status.h"
#include "evt1/g_dnc_task_32b.h"
#include "evt1/g_dnc_task_done.h"
#include "evt1/g_dnc_exception.h"
#include "evt1/g_dnc_sync.h"
#include "evt1/g_dnc_uan_nc.h"
#include "evt1/g_dnc_uan_ab.h"
#include "evt1/g_dnc_uan_comp.h"
#include "evt1/g_dnc_uan_sp.h"
...
/* evt1 */
#define TASK_32B_ALI0						(0x970)
#define TASK_32B_ALI1						(0x9A0)
#define TASK_32B_ALI2						(0x9D0)
