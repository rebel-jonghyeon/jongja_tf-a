...
#ifndef _G_DNC_EXCEPTION_EVT0_H_
#define _G_DNC_EXCEPTION_EVT0_H_
...
union dnc_exception_exception3 {
	struct __attribute__((packed)) {
		...
		uint32_t cbus_ce : 1;
		uint32_t rsvd3 : 1;
		uint32_t comp_credit_vio_turq : 1;
		uint32_t comp_credit_vio_task : 1;
		uint32_t comp_credit_vio_desc : 1;
		uint32_t ldudma_credit_vio_turq : 1;
		uint32_t ldudma_credit_vio_task : 1;
		uint32_t ldudma_credit_vio_desc : 1;
		uint32_t lpudma_credit_vio_turq : 1;
		uint32_t lpudma_credit_vio_task : 1;
		uint32_t lpudma_credit_vio_desc : 1;
		uint32_t studma_credit_vio_turq : 1;
		uint32_t studma_credit_vio_task : 1;
...
#endif /* _G_DNC_EXCEPTION_EVT0_H_*/
