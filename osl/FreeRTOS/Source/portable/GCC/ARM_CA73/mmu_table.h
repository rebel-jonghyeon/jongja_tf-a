...
extern const char text_region_start[];
extern const char text_region_end[];
extern const char rodata_region_start[];
extern const char rodata_region_end[];
extern const char data_region_start[];
extern const char data_region_end[];
extern const char dma_mcode_start[];
extern const char dma_mcode_end[];
extern const char dma_reserved_start[];
extern const char dma_reserved_end[];
extern const char dma_smmu_region_start[];
extern const char dma_smmu_region_end[];
extern const char dma_smmu_reserved_start[];
extern const char dma_smmu_reserved_end[];
extern const char heap_region_start[];
extern const char heap_region_end[];
extern const char dyn_heap_region_start[];
extern const char dyn_heap_region_end[];

volatile const struct mmu_flat_range mmu_os_ranges[] = {
	{
		.name	= "text",
		.start	= (void *)text_region_start,
		.end	= (void *)text_region_end,
		.attrs	= MT_NORMAL | MT_P_RX_U_NA | MT_NS,
	},
	{
		.name	= "rodata",
		.start	= (void *)rodata_region_start,
		.end	= (void *)rodata_region_end,
		.attrs	= MT_NORMAL | MT_P_RO_U_NA | MT_NS,
	},
	{
		.name	= "data",
		.start	= (void *)data_region_start,
		.end	= (void *)data_region_end,
		.attrs	= MT_NORMAL | MT_P_RW_U_NA | MT_NS,
	},
	{
		.name	= "dma",
		.start	= (void *)dma_mcode_start,
		.end	= (void *)dma_smmu_reserved_end,
		.attrs	= MT_NORMAL_NC | MT_P_RW_U_NA | MT_NS,
	},
	{
		.name	= "heap",
		.start	= (void *)heap_region_start,
		.end	= (void *)heap_region_end,
		.attrs	= MT_NORMAL | MT_P_RW_U_NA | MT_NS,
	},
	{
		.name	= "dyn_heap",
		.start	= (void *)dyn_heap_region_start,
		.end	= (void *)dyn_heap_region_end,
		.attrs	= MT_NORMAL | MT_P_RW_U_NA | MT_NS,
	},
};

volatile const struct mmu_region mmu_regions[] = {
	...
	MMU_REGION_FLAT_ENTRY("(HBM:Chiplet 0) Zepher:RW - CP1",
						  ...
						  0x00029C00000ULL,
						  MT_NORMAL_NC | MT_P_RW_U_NA | MT_NS),
	MMU_REGION_FLAT_ENTRY("(HBM:Chiplet 0) Host",
						  0x01000000000ULL,
						  0x00000001000ULL,
						  MT_DEVICE_nGnRnE | MT_P_RW_U_NA | MT_NS),
	MMU_REGION_FLAT_ENTRY("(HBM:Chiplet 0) Host Bell",
						  0x01BFFFFF000ULL,
						  0x00000001000ULL,
						  MT_DEVICE_nGnRnE | MT_P_RW_U_NA | MT_NS),
#endif
	...
	MMU_REGION_FLAT_ENTRY("(HBM:Chiplet 0) PCIe DBI region",
						  0x01C00000000ULL,
						  0x00200000000ULL,
						  MT_DEVICE_nGnRnE | MT_P_RW_U_NA | MT_NS),

	/* TODO: Some drivers access this region. Request to Rebellions. */
