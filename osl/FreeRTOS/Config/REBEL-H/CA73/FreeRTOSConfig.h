...
#define configTIMER_QUEUE_LENGTH                512
...
#define configINTERRUPT_CONTROLLER_BASE_ADDRESS 0x60000000
#define configINTERRUPT_CONTROLLER_CPU_INTERFACE_OFFSET /* needed to avoid compile error */
